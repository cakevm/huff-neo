...
fn test_prefix_event_arg_names_with_reserved_keywords() {
    ...
    let expected_tokens: Vec<Token> = vec![
        ...
        Token { kind: TokenKind::Ident("TestEvent".to_string()), span: Span { start: 14, end: 23, file: None } },
        Token { kind: TokenKind::OpenParen, span: Span { start: 23, end: 24, file: None } },
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bytes(4)), span: Span { start: 24, end: 30, file: None } },
        ...
        Token { kind: TokenKind::Ident("interfaceId".to_string()), span: Span { start: 39, end: 50, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Uint(256)), span: Span { start: 52, end: 59, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 59, end: 60, file: None } },
        Token { kind: TokenKind::Ident("uintTest".to_string()), span: Span { start: 60, end: 68, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bool), span: Span { start: 70, end: 74, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 74, end: 75, file: None } },
        Token { kind: TokenKind::Ident("stringMe".to_string()), span: Span { start: 75, end: 83, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::String), span: Span { start: 85, end: 91, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 91, end: 92, file: None } },
        Token { kind: TokenKind::Ident("boolean".to_string()), span: Span { start: 92, end: 99, file: None } },
    ...
    let sources = [
        (
            ...
            EventDefinition {
                ...
                hash: [
                    96, 60, 104, 14, 131, 197, 151, 167, 15, 107, 26, 61, 1, 186, 238, 67, 62, 152, 177, 8, 184, 82, 242, 224, 18, 70, 210,
                    27, 27, 119, 23, 114,
                ],
            },
        ),
