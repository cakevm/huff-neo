use huff_neo_utils::abi::*;
use std::collections::HashMap;

#[test]
fn convert_function_param_type() {
    let func_types = ["bool", "string", "address", "uint198", "bytes32", "bytes", "uint[][]", "address[5][]", "bool[][1][][2]"];
...
fn test_display_func_param_type() {
    let func_types = ["bool", "string", "address", "uint198", "uint", "bytes32", "bytes", "uint256[][]", "address[5][]", "bool[][1][][2]"];
