...
fn test_code_table_with_right_pad_func_sig() {
    ...
    // 60 = PUSH1, 24 = 36 bytes table size, 61 = PUSH2, 0005 = 5 bytes table start, a9059cbb = transfer(address,uint256)
    assert_eq!(mbytes, "60 24 61 0005 a9059cbb00000000000000000000000000000000000000000000000000000000 DEADBEEF".replace(" ", ""));
}
