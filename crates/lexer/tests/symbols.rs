...
fn lexes_assign_op() {
    ...
    assert_eq!(unwrapped, Token::new(TokenKind::Ident("TRANSFER_EVENT_SIGNATURE".to_string()), function_span));
...
fn lexes_brackets() {
    ...
    assert_eq!(unwrapped, Token::new(TokenKind::Ident("TOTAL_SUPPLY_LOCATION".to_string()), loc_span));
