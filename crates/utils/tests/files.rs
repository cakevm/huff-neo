...
use huff_neo_utils::{files, prelude::Span};
...
fn test_localize_file() {
    let localized = files::FileSource::localize_file("./examples/ERC20.huff", "./utilities/Address.huff").unwrap();
    assert_eq!(localized, "./examples/utilities/Address.huff");
    let localized = files::FileSource::localize_file("./ERC20.huff", "./utilities/Address.huff").unwrap();
    ...
    let localized = files::FileSource::localize_file("./ERC20.huff", "Address.huff").unwrap();
    assert_eq!(localized, "./Address.huff");
    let localized = files::FileSource::localize_file("./examples/ERC20.huff", "Address.huff").unwrap();
    ...
    let localized = files::FileSource::localize_file("../../examples/ERC20.huff", "../../../Address.huff").unwrap();
    assert_eq!(localized, "../../../../Address.huff");
    let localized = files::FileSource::localize_file("examples/ERC20.huff", "../random_dir/Address.huff").unwrap();
