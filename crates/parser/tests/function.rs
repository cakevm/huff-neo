            ...
            FunctionDefinition {
                ...
                inputs: vec![
                    ...
                    Argument {
                        ...
                        indexed: false,
                        arg_location: None,
                        span: AstSpan(vec![Span { start: 30, end: 33, file: None }, Span { start: 35, end: 35, file: None }]),
                    },
                ],
...
fn test_can_prefix_function_arg_names_with_reserved_keywords() {
    ...
    let expected_tokens: Vec<Token> = vec![
        ...
        Token { kind: TokenKind::Ident("supportsInterface".to_string()), span: Span { start: 17, end: 33, file: None } },
        Token { kind: TokenKind::OpenParen, span: Span { start: 34, end: 34, file: None } },
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bytes(4)), span: Span { start: 35, end: 40, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 41, end: 41, file: None } },
        Token { kind: TokenKind::Ident("interfaceId".to_string()), span: Span { start: 42, end: 52, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bool), span: Span { start: 69, end: 72, file: None } },
