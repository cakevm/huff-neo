...
fn multiline_labels() {
    ...
    let md_expected = MacroDefinition {
        ...
        parameters: vec![],
        statements: vec![
            Statement { ty: StatementType::Literal(str_to_bytes32("00")), span: AstSpan(vec![Span { start: 65, end: 66, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Mstore), span: AstSpan(vec![Span { start: 68, end: 73, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("01")), span: AstSpan(vec![Span { start: 83, end: 84, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("02")), span: AstSpan(vec![Span { start: 88, end: 89, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Add), span: AstSpan(vec![Span { start: 91, end: 93, file: None }]) },
            Statement {
