...
fn macro_with_simple_body() {
    ...
    let expected = MacroDefinition {
        ...
        parameters: vec![],
        statements: vec![
            Statement { ty: StatementType::Literal(str_to_bytes32("00")), span: AstSpan(vec![Span { start: 54, end: 55, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Mstore), span: AstSpan(vec![Span { start: 57, end: 62, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("01")), span: AstSpan(vec![Span { start: 67, end: 68, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("02")), span: AstSpan(vec![Span { start: 72, end: 73, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Add), span: AstSpan(vec![Span { start: 75, end: 77, file: None }]) },
        ],
        takes: 3,
        returns: 0,
        span: AstSpan(vec![
...
fn macro_with_arg_calls() {
    ...
    let expected = MacroDefinition {
        ...
        decorator: None,
        statements: vec![
            Statement { ty: StatementType::Opcode(Opcode::Dup2), span: AstSpan(vec![Span { start: 209, end: 212, file: None }]) },
            Statement {
            ...
            Statement { ty: StatementType::Opcode(Opcode::Sub), span: AstSpan(vec![Span { start: 845, end: 847, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Dup3), span: AstSpan(vec![Span { start: 911, end: 914, file: None }]) },
            Statement {
                ty: StatementType::Constant("BALANCE_LOCATION".to_string()),
...
fn macro_invocation_with_arg_call() {
    ...
    let expected = MacroDefinition {
        ...
        statements: vec![
            ...
            Statement { ty: StatementType::Literal(str_to_bytes32("01")), span: AstSpan(vec![Span { start: 140, end: 141, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("00")), span: AstSpan(vec![Span { start: 145, end: 146, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Mstore), span: AstSpan(vec![Span { start: 148, end: 153, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("20")), span: AstSpan(vec![Span { start: 165, end: 166, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("00")), span: AstSpan(vec![Span { start: 170, end: 171, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Return), span: AstSpan(vec![Span { start: 173, end: 178, file: None }]) },
        ],
        takes: 0,
        returns: 0,
        span: AstSpan(vec![
...
fn outlined_macro_with_simple_body() {
    ...
    let expected = MacroDefinition {
        ...
        parameters: vec![],
        statements: vec![
            Statement { ty: StatementType::Literal(str_to_bytes32("00")), span: AstSpan(vec![Span { start: 51, end: 52, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Mstore), span: AstSpan(vec![Span { start: 54, end: 59, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("01")), span: AstSpan(vec![Span { start: 64, end: 65, file: None }]) },
            Statement { ty: StatementType::Literal(str_to_bytes32("02")), span: AstSpan(vec![Span { start: 69, end: 70, file: None }]) },
            Statement { ty: StatementType::Opcode(Opcode::Add), span: AstSpan(vec![Span { start: 72, end: 74, file: None }]) },
        ],
        takes: 3,
        returns: 0,
        span: AstSpan(vec![
...
fn test_with_simple_body() {
    ...
    let expected = MacroDefinition {
        ...
        statements: vec![
            ...
            Statement { ty: StatementType::Opcode(Opcode::Mstore), span: AstSpan(vec![Span { start: 61, end: 66, file: None }]) },
            Statement {
                ty: StatementType::Literal([
            ...
            Statement { ty: StatementType::Opcode(Opcode::Add), span: AstSpan(vec![Span { start: 79, end: 81, file: None }]) },
        ],
        takes: 3,
        returns: 0,
        span: AstSpan(vec![
