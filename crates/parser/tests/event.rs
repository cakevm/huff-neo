...
fn test_prefix_event_arg_names_with_reserved_keywords() {
    ...
    let expected_tokens: Vec<Token> = vec![
        ...
        Token { kind: TokenKind::Ident("TestEvent".to_string()), span: Span { start: 14, end: 22, file: None } },
        Token { kind: TokenKind::OpenParen, span: Span { start: 23, end: 23, file: None } },
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bytes(4)), span: Span { start: 24, end: 29, file: None } },
        ...
        Token { kind: TokenKind::Ident("interfaceId".to_string()), span: Span { start: 39, end: 49, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Uint(256)), span: Span { start: 52, end: 58, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 59, end: 59, file: None } },
        Token { kind: TokenKind::Ident("uintTest".to_string()), span: Span { start: 60, end: 67, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::Bool), span: Span { start: 70, end: 73, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 74, end: 74, file: None } },
        Token { kind: TokenKind::Ident("stringMe".to_string()), span: Span { start: 75, end: 82, file: None } },
        ...
        Token { kind: TokenKind::PrimitiveType(PrimitiveEVMType::String), span: Span { start: 85, end: 90, file: None } },
        Token { kind: TokenKind::Whitespace, span: Span { start: 91, end: 91, file: None } },
        Token { kind: TokenKind::Ident("boolean".to_string()), span: Span { start: 92, end: 98, file: None } },
